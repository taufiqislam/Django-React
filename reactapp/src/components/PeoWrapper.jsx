...
export const PeoWrapper = () => {
    ...
    const addPeo = peos => {
      const requestData = {upSyllabus: upSyllabuses.id, descriptionPEO: peos, isEditing: false};
    ...
    const requestData = {upSyllabus: upSyllabuses.id, descriptionPEO: descriptionPEO };
